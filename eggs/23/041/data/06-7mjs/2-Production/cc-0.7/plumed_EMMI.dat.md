...
**Source:** 06-7mjs/2-Production/cc-0.7/plumed_EMMI.dat  
...
<div style="width: 90%; float:left" id="value_details_data/06-7mjs/2-Production/cc-0.7/plumed_EMMI.dat"> Click on the labels of the actions for more information on what each action computes </div>
...
<div class="tooltip">ENTITY0<div class="right">the atoms that make up a molecule that you wish to align<i></i></div></div>=<b name="data/06-7mjs/2-Production/cc-0.7/plumed_EMMI.datsystem-map">system-map</b> <div class="tooltip">STRIDE<div class="right"> the frequency with which molecules are reassembled<i></i></div></div>=4
... WHOLEMOLECULES
...
<div class="tooltip">LABEL<div class="right">a label for the action so that its output can be referenced in the input to other actions<i></i></div></div>=<b name="data/06-7mjs/2-Production/cc-0.7/plumed_EMMI.datemmi" onclick='showPath("data/06-7mjs/2-Production/cc-0.7/plumed_EMMI.dat","data/06-7mjs/2-Production/cc-0.7/plumed_EMMI.datemmi")'>emmi</b>
...
<div class="tooltip">ATOMS<div class="right">atoms used in the calculation of the density map, typically all heavy atoms<i></i></div></div>=<b name="data/06-7mjs/2-Production/cc-0.7/plumed_EMMI.datsystem-map">system-map</b> <div class="tooltip">DATA_FILE<div class="right">file with cryo-EM map<i></i></div></div>=emd_plumed_aligned.dat
