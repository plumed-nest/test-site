...
**Last tested:**  17 Jun 2026, 09:15:25
  
**Project description and instructions**  
Initial configurations, run files for GROMACS and two complete examples of metadynamics are included.
  
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=MOLINFO,LOWER_WALLS,PRINT,GYRATION,COM,UPPER_WALLS,DISTANCE,PBMETAD" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
