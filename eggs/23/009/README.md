...
**Last tested:**  17 Jun 2026, 09:16:21
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PRINT,ENERGY,PYTORCH_MODEL,UPPER_WALLS,GROUP,COMBINE,COORDINATION,ENDPLUMED,CUSTOM,CENTER,LOWER_WALLS,ANGLE,WHOLEMOLECULES,RMSD,MOLINFO,INCLUDE,FIT_TO_TEMPLATE,CONTACTMAP,DISTANCE,COMMITTOR,OPES_METAD,FIXEDATOM,MATHEVAL" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
