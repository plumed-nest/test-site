...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COMBINE,LOWER_WALLS,COORDINATIONNUMBER,PRINT,GROUP,METAD,LOCAL_Q6,MOVINGRESTRAINT,MFILTER_MORE,Q6" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
