...
**Last tested:**  17 Jun 2026, 09:18:38
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=PYTORCH_MODEL,COORDINATION,CUSTOM,WHOLEMOLECULES,LOWER_WALLS,OPES_METAD_EXPLORE,DISTANCE,FIXEDATOM,OPES_METAD,GROUP,UNITS,TORSION,UPPER_WALLS,FIT_TO_TEMPLATE,CENTER,PRINT,PATH" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
