...
<div class="headerInfo" id="value_details_data/Case_2/Test_1/1D_lambda_MetaD/rep_1/State_B/plumed.dat"> Click on the labels of the actions for more information on what each action computes </div>
