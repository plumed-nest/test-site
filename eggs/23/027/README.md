...
**Last tested:**  17 Jun 2026, 09:13:02
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=LOCAL_AVERAGE,RESTRAINT,COORDINATIONNUMBER,CLUSTER_NATOMS,CONTACT_MATRIX,UNITS,PRINT,CLUSTER_DISTRIBUTION,AROUND,DUMPGRID,Q3,GROUP,LOCAL_Q3,DENSITY,HISTOGRAM,LOAD,FIXEDATOM,DFSCLUSTERING" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
