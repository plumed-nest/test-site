...
**Last tested:**  17 Jun 2026, 09:29:50
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATION,LOAD,WHOLEMOLECULES,FIXEDATOM,TORSION,PYTORCH_MODEL,OPES_METAD,LOWER_WALLS,DISTANCES,UPPER_WALLS,GROUP,PRINT,FIT_TO_TEMPLATE,DISTANCE,MATHEVAL,UNITS,CENTER,ENDPLUMED,ANGLE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
