...
**Last tested:**  17 Jun 2026, 09:24:36
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COORDINATIONNUMBER,Q6,CLUSTER_NATOMS,CONTACT_MATRIX,PRINT,CLUSTER_DISTRIBUTION,COMBINE,DUMPGRID,LOCAL_Q6,MFILTER_MORE,METAD,GROUP,HISTOGRAM,INSPHERE,FIXEDATOM,DFSCLUSTERING" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
