...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=COMMITTOR,PYTORCH_MODEL,DISTANCE,POSITION,RMSD,CUSTOM,CONSTANT,TORSION,ENDPLUMED,INCLUDE,WHOLEMOLECULES,MOLINFO,COMBINE,OPES_METAD,UNITS,PRINT,GROUP,ENERGY,CONTACTMAP,BIASVALUE" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
