...
**Last tested:**  17 Jun 2026, 09:28:21
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=VES_OUTPUT_BASISFUNCTIONS,BF_WAVELETS,COORDINATION,VES_LINEAR_EXPANSION,ENERGY,FLUSH,TD_UNIFORM,UPPER_WALLS,METAD,PRINT,INCLUDE,POSITION,BF_GAUSSIANS,OPT_AVERAGED_SGD,DISTANCE,BF_CHEBYSHEV,UNITS,BF_LEGENDRE,TD_WELLTEMPERED,OPT_ADAM,BF_CUBIC_B_SPLINES" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
