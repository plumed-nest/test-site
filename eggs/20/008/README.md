...
**Publication:** [K. Rossi, V. Jurásková, R. Wischert, L. Garel, C. Corminbœuf, M. Ceriotti, Simulating Solvation and Acidity in Complex Mixtures with First-Principles Accuracy: The Case of CH<sub>3</sub>SO<sub>3</sub>H and H<sub>2</sub>O<sub>2</sub> in Phenol. Journal of Chemical Theory and Computation 16, 5139–5149 (2020)](http://dx.doi.org/10.1021/acs.jctc.0c00362)  
...
**Last tested:**  17 Jun 2026, 09:27:45
...
{% raw %}
<b><a href="https://www.plumed.org/doc-master/user-doc/html/actionlist/?actions=DISTANCES,UNITS,METAD,PRINT,COORDINATION,CUSTOM" target="_blank">Click here</a> to open manual pages for actions used in this project.</b>
{% endraw %}
**Submission history**  
