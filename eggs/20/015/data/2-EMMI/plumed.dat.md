...
<br/><span style="color:blue"># load extra file</span>
...
<div class="tooltip">LABEL<div class="right">a label for the action so that its output can be referenced in the input to other actions<i></i></div></div>=<b name="data/2-EMMI/plumed.datgmm" onclick='showPath("data/2-EMMI/plumed.dat","data/2-EMMI/plumed.datgmm")'>gmm</b>
