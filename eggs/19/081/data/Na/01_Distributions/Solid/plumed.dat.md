...
<div class="headerInfo" id="value_details_data/Na/01_Distributions/Solid/plumed.dat"> Click on the labels of the actions for more information on what each action computes </div>
