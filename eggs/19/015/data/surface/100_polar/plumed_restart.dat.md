...
<div class="headerInfo" id="value_details_data/surface/100_polar/plumed_restart.dat"> Click on the labels of the actions for more information on what each action computes </div>
...
<span class="plumedtooltip">LABEL<span class="right">a label for the action so that its output can be referenced in the input to other actions<i></i></span></span>=<b name="data/surface/100_polar/plumed_restart.datmetad" onclick='showPath("data/surface/100_polar/plumed_restart.dat","data/surface/100_polar/plumed_restart.datmetad","data/surface/100_polar/plumed_restart.datmetad","brown")'>metad</b>
