...
<div style="width: 90%; float:left" id="value_details_data/MulticanonicalSimulations/References/Temp550K/plumed.dat"> Click on the labels of the actions for more information on what each action computes </div>
...
<br/><b name="data/MulticanonicalSimulations/References/Temp550K/plumed.datenergy" onclick='showPath("data/MulticanonicalSimulations/References/Temp550K/plumed.dat","data/MulticanonicalSimulations/References/Temp550K/plumed.datenergy")'>energy</b>: <div class="tooltip" style="color:green">ENERGY<div class="right">Calculate the total potential energy of the simulation box. <a href="https://www.plumed.org/doc-master/user-doc/html/_e_n_e_r_g_y.html" style="color:green">More details</a><i></i></div></div>
