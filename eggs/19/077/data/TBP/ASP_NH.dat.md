...
**Source:** TBP/ASP_NH.dat  
**Originally used with PLUMED version:** 2.4  
**Stable:** [raw zipped stdout](ASP_NH.dat.plumed.stdout.txt.zip) - [stderr](ASP_NH.dat.plumed.stderr)  
**Master:** [raw zipped stdout](ASP_NH.dat.plumed_master.stdout.txt.zip) - [stderr](ASP_NH.dat.plumed_master.stderr)  
...
d1: <a href="https://plumed.github.io/doc-master/user-doc/html/_d_i_s_t_a_n_c_e.html">DISTANCE</a> ATOMS=2320,c1 COMPONENTS NOPBC <span style="color:blue">#dist peptide to surface</span>
