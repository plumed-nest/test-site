...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.BAE0sg.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.BAE0sg.cpp:72:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
72 |   bool serial,pbc;
|               ^~~
Graph.BAE0sg.cpp:72:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
72 |   bool serial,pbc;
|        ^~~~~~
Graph.BAE0sg.cpp:106:1: warning:   when initialized here [-Wreorder]
106 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.BAE0sg.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.BAE0sg.cpp:213:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.BAE0sg.cpp:214:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
214 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.BAE0sg.cpp:219:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
219 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.BAE0sg.cpp:220:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
220 |     rank = comm.Get_rank(); // Somehow it is always rank=0. Does MPI really work? (T)
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.BAE0sg.cpp:223:3: error: ‘Matrix’ was not declared in this scope
223 |   Matrix<double> dist_mat(nat, nat);
|   ^~~~~~
Graph.BAE0sg.cpp:223:10: error: expected primary-expression before ‘double’
223 |   Matrix<double> dist_mat(nat, nat);
|          ^~~~~~
Graph.BAE0sg.cpp:224:16: error: expected primary-expression before ‘>’ token
224 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                ^
Graph.BAE0sg.cpp:224:18: error: ‘dist_deriv_mat’ was not declared in this scope
224 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                  ^~~~~~~~~~~~~~
Graph.BAE0sg.cpp:240:11: error: ‘dist_mat’ was not declared in this scope
240 |           dist_mat[i][j] = value;
|           ^~~~~~~~
Graph.BAE0sg.cpp:231:18: warning: unused variable ‘d2’ [-Wunused-variable]
231 |           double d2;
|                  ^~
Graph.BAE0sg.cpp:259:19: error: ‘dist_mat’ was not declared in this scope
...
[runnervm1li68:06143] *** Process received signal ***
[runnervm1li68:06143] Signal: Aborted (6)
[runnervm1li68:06143] Signal code:  (-6)
[runnervm1li68:06143] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f0b6c045330]
[runnervm1li68:06143] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f0b6c09eb2c]
[runnervm1li68:06143] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f0b6c04527e]
[runnervm1li68:06143] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f0b6c0288ff]
[runnervm1li68:06143] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f0b6c4a5ff5]
[runnervm1li68:06143] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f0b6c4bb0da]
[runnervm1li68:06143] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f0b6c4a5a55]
[runnervm1li68:06143] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f0b6c4a5a6f]
[runnervm1li68:06143] [ 8] plumed(+0x146dd)[0x5609dd7e06dd]
[runnervm1li68:06143] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f0b6c02a1ca]
[runnervm1li68:06143] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f0b6c02a28b]
[runnervm1li68:06143] [11] plumed(+0x15365)[0x5609dd7e1365]
[runnervm1li68:06143] *** End of error message ***
</pre>
{% endraw %}
