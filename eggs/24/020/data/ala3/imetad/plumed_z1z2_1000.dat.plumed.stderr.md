...
Download: [zipped raw stdout](plumed_z1z2_1000.dat.plumed.stdout.txt.zip) - [zipped raw stderr](plumed_z1z2_1000.dat.plumed.stderr.txt.zip) 
{% raw %}
<pre>
...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.doFC3j.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.doFC3j.cpp:49:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
49 |   bool serial,pbc;
|               ^~~
Graph.doFC3j.cpp:49:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
49 |   bool serial,pbc;
|        ^~~~~~
Graph.doFC3j.cpp:81:1: warning:   when initialized here [-Wreorder]
81 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.doFC3j.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.doFC3j.cpp:187:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.doFC3j.cpp:188:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
188 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.doFC3j.cpp:193:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
193 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.doFC3j.cpp:194:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
194 |     rank = comm.Get_rank(); // Somehow it is always rank=0. Does MPI really work? (T)
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.doFC3j.cpp:197:3: error: ‘Matrix’ was not declared in this scope
197 |   Matrix<double> dist_mat(nat, nat);
|   ^~~~~~
Graph.doFC3j.cpp:197:10: error: expected primary-expression before ‘double’
197 |   Matrix<double> dist_mat(nat, nat);
|          ^~~~~~
Graph.doFC3j.cpp:198:16: error: expected primary-expression before ‘>’ token
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                ^
Graph.doFC3j.cpp:198:18: error: ‘dist_deriv_mat’ was not declared in this scope
198 |   Matrix<Vector> dist_deriv_mat(nat, nat);
|                  ^~~~~~~~~~~~~~
Graph.doFC3j.cpp:213:7: error: ‘dist_mat’ was not declared in this scope
213 |       dist_mat[i][j] = value;
|       ^~~~~~~~
Graph.doFC3j.cpp:205:18: warning: unused variable ‘d2’ [-Wunused-variable]
205 |           double d2;
|                  ^~
Graph.doFC3j.cpp:232:19: error: ‘dist_mat’ was not declared in this scope
...
[fv-az1672-644:05999] *** Process received signal ***
[fv-az1672-644:05999] Signal: Aborted (6)
[fv-az1672-644:05999] Signal code:  (-6)
[fv-az1672-644:05999] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f0115645330]
[fv-az1672-644:05999] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f011569eb2c]
[fv-az1672-644:05999] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f011564527e]
[fv-az1672-644:05999] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f01156288ff]
[fv-az1672-644:05999] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f0115aa5ff5]
[fv-az1672-644:05999] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f0115abb0da]
[fv-az1672-644:05999] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f0115aa5a55]
[fv-az1672-644:05999] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f0115aa5a6f]
[fv-az1672-644:05999] [ 8] plumed(+0x146dd)[0x5601a54176dd]
[fv-az1672-644:05999] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f011562a1ca]
[fv-az1672-644:05999] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f011562a28b]
[fv-az1672-644:05999] [11] plumed(+0x15365)[0x5601a5418365]
[fv-az1672-644:05999] *** End of error message ***
</pre>
{% endraw %}
