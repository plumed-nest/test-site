...
... METAD
</span><span id="data/ala3/imetad/plumed_phi_1000.datdefmtd_long" style="display:none;"><span class="plumedtooltip" style="color:green">METAD<span class="right">Used to performed metadynamics on one or more collective variables. This action uses the <a class="toggler" href='javascript:;' onclick='toggleDisplay("data/ala3/imetad/plumed_phi_1000.datdefmtd");'>defaults shown here</a>. <a href="https://www.plumed.org/doc-master/user-doc/html/_m_e_t_a_d.html">More details</a><i></i></span></span> ...
  <span class="plumedtooltip">LABEL<span class="right">a label for the action so that its output can be referenced in the input to other actions<i></i></span></span>=<b name="data/ala3/imetad/plumed_phi_1000.datmtd" onclick='showPath("data/ala3/imetad/plumed_phi_1000.dat","data/ala3/imetad/plumed_phi_1000.datmtd","data/ala3/imetad/plumed_phi_1000.datmtd","black")'>mtd</b>
