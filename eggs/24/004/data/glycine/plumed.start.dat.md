...
<div class="headerInfo" id="value_details_data/glycine/plumed.start.dat"> Click on the labels of the actions for more information on what each action computes </div>
