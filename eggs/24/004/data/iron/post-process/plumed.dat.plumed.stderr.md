...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.Kr1GOW.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
Graph.Kr1GOW.cpp:46:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
Graph.Kr1GOW.cpp:46:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
46 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
Graph.Kr1GOW.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.Kr1GOW.cpp:82:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
82 |   bool serial,pbc;
|               ^~~
Graph.Kr1GOW.cpp:82:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
82 |   bool serial,pbc;
|        ^~~~~~
Graph.Kr1GOW.cpp:107:1: warning:   when initialized here [-Wreorder]
107 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.Kr1GOW.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.Kr1GOW.cpp:179:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.Kr1GOW.cpp:180:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
180 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.Kr1GOW.cpp:185:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
185 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.Kr1GOW.cpp:186:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
186 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.Kr1GOW.cpp:189:3: error: ‘Matrix’ was not declared in this scope
189 |   Matrix<double> dist_mat(nat, kcut);
|   ^~~~~~
Graph.Kr1GOW.cpp:189:10: error: expected primary-expression before ‘double’
189 |   Matrix<double> dist_mat(nat, kcut);
|          ^~~~~~
Graph.Kr1GOW.cpp:190:10: error: expected primary-expression before ‘double’
190 |   Matrix<double> idxn_mat(nat, kcut);
|          ^~~~~~
Graph.Kr1GOW.cpp:191:16: error: expected primary-expression before ‘>’ token
191 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                ^
Graph.Kr1GOW.cpp:191:18: error: ‘dist_deriv_mat’ was not declared in this scope
191 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                  ^~~~~~~~~~~~~~
Graph.Kr1GOW.cpp:211:11: error: ‘dist_mat’ was not declared in this scope
211 |           dist_mat[i][k-1] += dist_array[idx];
|           ^~~~~~~~
Graph.Kr1GOW.cpp:212:11: error: ‘idxn_mat’ was not declared in this scope
212 |           idxn_mat[i][k-1] += idx;
|           ^~~~~~~~
Graph.Kr1GOW.cpp:218:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
218 |         comm.Sum(dist_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.Kr1GOW.cpp:218:18: error: ‘dist_mat’ was not declared in this scope
218 |         comm.Sum(dist_mat);
|                  ^~~~~~~~
Graph.Kr1GOW.cpp:219:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
219 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.Kr1GOW.cpp:219:18: error: ‘idxn_mat’ was not declared in this scope
219 |         comm.Sum(idxn_mat);
|                  ^~~~~~~~
Graph.Kr1GOW.cpp:220:5: error: invalid use of incomplete type ‘class PLMD::Communicator’
220 |     comm.Sum(dist_deriv_mat);
|     ^~~~
/home/runner/opt/include/plumed/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.Kr1GOW.cpp:224:25: error: ‘dist_mat’ was not declared in this scope
224 |   vector<double> input1=dist_mat.getVector();
|                         ^~~~~~~~
Graph.Kr1GOW.cpp:225:25: error: ‘idxn_mat’ was not declared in this scope
...
[fv-az1372-996:06303] *** Process received signal ***
[fv-az1372-996:06303] Signal: Aborted (6)
[fv-az1372-996:06303] Signal code:  (-6)
[fv-az1372-996:06303] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f92c7e45330]
[fv-az1372-996:06303] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f92c7e9eb2c]
[fv-az1372-996:06303] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f92c7e4527e]
[fv-az1372-996:06303] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f92c7e288ff]
[fv-az1372-996:06303] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f92c82a5ff5]
[fv-az1372-996:06303] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f92c82bb0da]
[fv-az1372-996:06303] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f92c82a5a55]
[fv-az1372-996:06303] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f92c82a5a6f]
[fv-az1372-996:06303] [ 8] plumed(+0x146dd)[0x55944dcfb6dd]
[fv-az1372-996:06303] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f92c7e2a1ca]
[fv-az1372-996:06303] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f92c7e2a28b]
[fv-az1372-996:06303] [11] plumed(+0x15365)[0x55944dcfc365]
[fv-az1372-996:06303] *** End of error message ***
</pre>
{% endraw %}
