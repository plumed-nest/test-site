...
Stderr for source:  iron/plumed.dat   
...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.QTKVkW.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
Graph.QTKVkW.cpp:45:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
Graph.QTKVkW.cpp:45:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
45 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
Graph.QTKVkW.cpp: In static member function ‘static void PLMD::colvar::GraphGenerator::registerKeywords(PLMD::Keywords&)’:
Graph.QTKVkW.cpp:102:26: warning: ‘void PLMD::Keywords::addOutputComponent(const std::string&, const std::string&, const std::string&)’ is deprecated: Use addOutputComponent with four argument and specify valid types for value from scalar/vector/matrix/grid [-Wdeprecated-declarations]
...
|        ^~~~~~~~~~~~~~~~~~
Graph.QTKVkW.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.QTKVkW.cpp:81:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
81 |   bool serial,pbc;
|               ^~~
Graph.QTKVkW.cpp:81:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
81 |   bool serial,pbc;
|        ^~~~~~
Graph.QTKVkW.cpp:106:1: warning:   when initialized here [-Wreorder]
106 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.QTKVkW.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.QTKVkW.cpp:176:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
|       ^~~~~~~~~~~~
Graph.QTKVkW.cpp:177:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
177 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.QTKVkW.cpp:182:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
182 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.QTKVkW.cpp:183:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
183 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.QTKVkW.cpp:186:3: error: ‘Matrix’ was not declared in this scope
186 |   Matrix<double> dist_mat(nat, kcut);
|   ^~~~~~
Graph.QTKVkW.cpp:186:10: error: expected primary-expression before ‘double’
186 |   Matrix<double> dist_mat(nat, kcut);
|          ^~~~~~
Graph.QTKVkW.cpp:187:10: error: expected primary-expression before ‘double’
187 |   Matrix<double> idxn_mat(nat, kcut);
|          ^~~~~~
Graph.QTKVkW.cpp:188:16: error: expected primary-expression before ‘>’ token
188 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                ^
Graph.QTKVkW.cpp:188:18: error: ‘dist_deriv_mat’ was not declared in this scope
188 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                  ^~~~~~~~~~~~~~
Graph.QTKVkW.cpp:208:11: error: ‘dist_mat’ was not declared in this scope
208 |           dist_mat[i][k-1] += dist_array[idx];
|           ^~~~~~~~
Graph.QTKVkW.cpp:209:11: error: ‘idxn_mat’ was not declared in this scope
209 |           idxn_mat[i][k-1] += idx;
|           ^~~~~~~~
Graph.QTKVkW.cpp:215:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
215 |         comm.Sum(dist_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.QTKVkW.cpp:215:18: error: ‘dist_mat’ was not declared in this scope
215 |         comm.Sum(dist_mat);
|                  ^~~~~~~~
Graph.QTKVkW.cpp:216:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
216 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.QTKVkW.cpp:216:18: error: ‘idxn_mat’ was not declared in this scope
216 |         comm.Sum(idxn_mat);
|                  ^~~~~~~~
Graph.QTKVkW.cpp:217:5: error: invalid use of incomplete type ‘class PLMD::Communicator’
217 |     comm.Sum(dist_deriv_mat);
|     ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.QTKVkW.cpp:221:25: error: ‘dist_mat’ was not declared in this scope
221 |   vector<double> input1=dist_mat.getVector();
|                         ^~~~~~~~
Graph.QTKVkW.cpp:222:25: error: ‘idxn_mat’ was not declared in this scope
222 |   vector<double> input2=idxn_mat.getVector();
|                         ^~~~~~~~
Graph.QTKVkW.cpp:269:11: error: invalid use of incomplete type ‘class PLMD::Communicator’
...
[fv-az1372-996:06159] *** Process received signal ***
[fv-az1372-996:06159] Signal: Aborted (6)
[fv-az1372-996:06159] Signal code:  (-6)
[fv-az1372-996:06159] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f9e69c45330]
[fv-az1372-996:06159] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f9e69c9eb2c]
[fv-az1372-996:06159] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f9e69c4527e]
[fv-az1372-996:06159] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f9e69c288ff]
[fv-az1372-996:06159] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f9e6a0a5ff5]
[fv-az1372-996:06159] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f9e6a0bb0da]
[fv-az1372-996:06159] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f9e6a0a5a55]
[fv-az1372-996:06159] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f9e6a0a5a6f]
[fv-az1372-996:06159] [ 8] plumed_master(+0x146dd)[0x555a9af006dd]
[fv-az1372-996:06159] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f9e69c2a1ca]
[fv-az1372-996:06159] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f9e69c2a28b]
[fv-az1372-996:06159] [11] plumed_master(+0x15365)[0x555a9af01365]
[fv-az1372-996:06159] *** End of error message ***
</pre>
{% endraw %}
