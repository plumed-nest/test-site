...
Stderr for source:  iron/plumed.start.dat   
...
127 |     struct _GLIBCXX17_DEPRECATED iterator
|                                  ^~~~~~~~
Graph.xKe1Df.cpp: In function ‘std::vector<float, std::allocator<float> > tensor_to_vector(const at::Tensor&)’:
Graph.xKe1Df.cpp:45:44: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
...
398 |   T * data() const {
|       ^~~~
Graph.xKe1Df.cpp:45:61: warning: ‘T* at::Tensor::data() const [with T = float]’ is deprecated: Tensor.data<T>() is deprecated. Please use Tensor.data_ptr<T>() instead. [-Wdeprecated-declarations]
45 |     return std::vector<float>(x.data<float>(), x.data<float>() + x.numel());
|                                                ~~~~~~~~~~~~~^~
/home/runner/opt/libtorch/include/ATen/core/TensorBody.h:398:7: note: declared here
398 |   T * data() const {
|       ^~~~
Graph.xKe1Df.cpp: In static member function ‘static void PLMD::colvar::GraphGenerator::registerKeywords(PLMD::Keywords&)’:
Graph.xKe1Df.cpp:102:26: warning: ‘void PLMD::Keywords::addOutputComponent(const std::string&, const std::string&, const std::string&)’ is deprecated: Use addOutputComponent with four argument and specify valid types for value from scalar/vector/matrix/grid [-Wdeprecated-declarations]
102 |   keys.addOutputComponent("node", "default", "NN outputs");
|   ~~~~~~~~~~~~~~~~~~~~~~~^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
|        ^~~~~~~~~~~~~~~~~~
Graph.xKe1Df.cpp: In constructor ‘PLMD::colvar::GraphGenerator::GraphGenerator(const PLMD::ActionOptions&)’:
Graph.xKe1Df.cpp:81:15: warning: ‘PLMD::colvar::GraphGenerator::pbc’ will be initialized after [-Wreorder]
81 |   bool serial,pbc;
|               ^~~
Graph.xKe1Df.cpp:81:8: warning:   ‘bool PLMD::colvar::GraphGenerator::serial’ [-Wreorder]
81 |   bool serial,pbc;
|        ^~~~~~
Graph.xKe1Df.cpp:106:1: warning:   when initialized here [-Wreorder]
106 | GraphGenerator::GraphGenerator(const ActionOptions&ao):
| ^~~~~~~~~~~~~~
Graph.xKe1Df.cpp: In member function ‘virtual void PLMD::colvar::GraphGenerator::calculate()’:
Graph.xKe1Df.cpp:176:21: error: invalid use of incomplete type ‘class PLMD::Communicator’
176 |   unsigned stride = comm.Get_size();
|                     ^~~~
...
|       ^~~~~~~~~~~~
Graph.xKe1Df.cpp:177:19: error: invalid use of incomplete type ‘class PLMD::Communicator’
177 |   unsigned rank = comm.Get_rank();
|                   ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.xKe1Df.cpp:182:14: error: invalid use of incomplete type ‘class PLMD::Communicator’
182 |     stride = comm.Get_size();
|              ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.xKe1Df.cpp:183:12: error: invalid use of incomplete type ‘class PLMD::Communicator’
183 |     rank = comm.Get_rank();
|            ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.xKe1Df.cpp:186:3: error: ‘Matrix’ was not declared in this scope
186 |   Matrix<double> dist_mat(nat, kcut);
|   ^~~~~~
Graph.xKe1Df.cpp:186:10: error: expected primary-expression before ‘double’
186 |   Matrix<double> dist_mat(nat, kcut);
|          ^~~~~~
Graph.xKe1Df.cpp:187:10: error: expected primary-expression before ‘double’
187 |   Matrix<double> idxn_mat(nat, kcut);
|          ^~~~~~
Graph.xKe1Df.cpp:188:16: error: expected primary-expression before ‘>’ token
188 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                ^
Graph.xKe1Df.cpp:188:18: error: ‘dist_deriv_mat’ was not declared in this scope
188 |   Matrix<Vector> dist_deriv_mat(nat, kcut);
|                  ^~~~~~~~~~~~~~
Graph.xKe1Df.cpp:208:11: error: ‘dist_mat’ was not declared in this scope
208 |           dist_mat[i][k-1] += dist_array[idx];
|           ^~~~~~~~
Graph.xKe1Df.cpp:209:11: error: ‘idxn_mat’ was not declared in this scope
209 |           idxn_mat[i][k-1] += idx;
|           ^~~~~~~~
Graph.xKe1Df.cpp:215:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
215 |         comm.Sum(dist_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.xKe1Df.cpp:215:18: error: ‘dist_mat’ was not declared in this scope
215 |         comm.Sum(dist_mat);
|                  ^~~~~~~~
Graph.xKe1Df.cpp:216:9: error: invalid use of incomplete type ‘class PLMD::Communicator’
216 |         comm.Sum(idxn_mat);
|         ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.xKe1Df.cpp:216:18: error: ‘idxn_mat’ was not declared in this scope
216 |         comm.Sum(idxn_mat);
|                  ^~~~~~~~
Graph.xKe1Df.cpp:217:5: error: invalid use of incomplete type ‘class PLMD::Communicator’
217 |     comm.Sum(dist_deriv_mat);
|     ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
Graph.xKe1Df.cpp:221:25: error: ‘dist_mat’ was not declared in this scope
221 |   vector<double> input1=dist_mat.getVector();
|                         ^~~~~~~~
Graph.xKe1Df.cpp:222:25: error: ‘idxn_mat’ was not declared in this scope
222 |   vector<double> input2=idxn_mat.getVector();
|                         ^~~~~~~~
Graph.xKe1Df.cpp:269:11: error: invalid use of incomplete type ‘class PLMD::Communicator’
269 |           comm.Sum(&deriv[0][0],3*getNumberOfAtoms());
|           ^~~~
/home/runner/opt/include/plumed_master/colvar/../core/../tools/FileBase.h:29:7: note: forward declaration of ‘class PLMD::Communicator’
29 | class Communicator;
|       ^~~~~~~~~~~~
...
[fv-az1372-996:06249] *** Process received signal ***
[fv-az1372-996:06249] Signal: Aborted (6)
[fv-az1372-996:06249] Signal code:  (-6)
[fv-az1372-996:06249] [ 0] /lib/x86_64-linux-gnu/libc.so.6(+0x45330)[0x7f364fc45330]
[fv-az1372-996:06249] [ 1] /lib/x86_64-linux-gnu/libc.so.6(pthread_kill+0x11c)[0x7f364fc9eb2c]
[fv-az1372-996:06249] [ 2] /lib/x86_64-linux-gnu/libc.so.6(gsignal+0x1e)[0x7f364fc4527e]
[fv-az1372-996:06249] [ 3] /lib/x86_64-linux-gnu/libc.so.6(abort+0xdf)[0x7f364fc288ff]
[fv-az1372-996:06249] [ 4] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5ff5)[0x7f36500a5ff5]
[fv-az1372-996:06249] [ 5] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xbb0da)[0x7f36500bb0da]
[fv-az1372-996:06249] [ 6] /lib/x86_64-linux-gnu/libstdc++.so.6(_ZSt10unexpectedv+0x0)[0x7f36500a5a55]
[fv-az1372-996:06249] [ 7] /lib/x86_64-linux-gnu/libstdc++.so.6(+0xa5a6f)[0x7f36500a5a6f]
[fv-az1372-996:06249] [ 8] plumed_master(+0x146dd)[0x558c0819f6dd]
[fv-az1372-996:06249] [ 9] /lib/x86_64-linux-gnu/libc.so.6(+0x2a1ca)[0x7f364fc2a1ca]
[fv-az1372-996:06249] [10] /lib/x86_64-linux-gnu/libc.so.6(__libc_start_main+0x8b)[0x7f364fc2a28b]
[fv-az1372-996:06249] [11] plumed_master(+0x15365)[0x558c081a0365]
[fv-az1372-996:06249] *** End of error message ***
</pre>
{% endraw %}
