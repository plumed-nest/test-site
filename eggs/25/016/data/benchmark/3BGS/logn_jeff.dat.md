...
**Source:** ./benchmark/3BGS/logn_jeff.dat  
...
<div class="headerInfo" id="value_details_data/./benchmark/3BGS/logn_jeff.dat"> Click on the labels of the actions for more information on what each action computes </div>
